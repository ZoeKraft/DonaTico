      ...
      {showInfo && (
        <div className="absolute top-0  w-full h-full  flex justify-center items-start pt-40 bg-black/70">
          <div className="bg-white w-11/12 max-w-md p-6 rounded-lg shadow-lg border border-green-400 text-green-800 relative">
            ...
            <p className="text-sm">
              Los proyectos en esta categoría están enfocados en la protección y el bienestar de los animales.
Incluyen:

            </p>
            <ul className="list-disc list-inside text-sm mt-5 flex flex-col gap-3">
              <li>Rescate de animales callejeros</li>
              <li>Programas de esterilización</li>
              <li>Refugios y adopciones responsables</li>
              <li>Conservación de especies en peligro</li>
              <li>Talleres de educación animal</li>
