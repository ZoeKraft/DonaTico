...
Incluyen:
            ...
            <ul className="list-disc list-inside text-sm mt-5 flex flex-col gap-3">
              <li>Construcción de espacios públicos</li>
              <li>Programas de integración social</li>
              <li>Actividades culturales y vecinales</li>
              <li>Talleres comunitarios</li>
              <li>Reparacion de calles publicas</li>
              <li>Limpieza de espacios publicos</li>
            </ul>
            <button
