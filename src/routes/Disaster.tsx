  ...
  return (
    <div className="relative">
      <Category
        ...
        title="Disasters"
        btnInfo={buttonInfo}
        searchPlaceholder="Buscar desastre..."
        campaign={campaigns}
      />
      ...
      {showInfo && (
        <div className="absolute top-0  w-full h-full  flex justify-center items-start pt-40 bg-black/70">
          <div className="bg-white w-11/12 max-w-md p-6 rounded-lg shadow-lg border border-green-400 text-green-800 relative">
            ...
            <p className="text-sm">
              Este tipo de proyectos son creados para ayudar a personas afectadas por desastres naturales. Incluyen:
            </p>
            <ul className="list-disc list-inside text-sm mt-5 flex flex-col gap-3">
              <li>Inundaciones en comunidades rurales</li>
              <li>Terremotos y reconstrucción</li>
              <li>Incendios forestales</li>
              <li>Evacuaciones y refugios temporales</li>
            </ul>
            <button
